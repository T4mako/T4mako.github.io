...
- a.norm(num,dim)：
  ...
  ![image-20240704134612532](./assets/image-20240704134612532.png)
...
![image-20240706152006704](./assets/image-20240706152006704.png)

softmax 的梯度/导数结论：

![image-20240706155454356](./assets/image-20240706155454356.png)
...
![image-20240706170053299](./assets/image-20240706170053299.png)
...
![image-20240706170840460](./assets/image-20240706170840460.png)

loss 对  w~j0~ 求导
$$
\frac{\partial E}{\partial w_{j0}} = (O_0 - t)O_0(1-O_0)x^0_j
$$
![image-20240706172743360](./assets/image-20240706172743360.png)
...
![image-20240706173822410](./assets/image-20240706173822410.png)
...
![image-20240706174221996](./assets/image-20240706174221996.png)
...
![image-20240707143212125](./assets/image-20240707143212125.png)
...
![image-20240707144509431](./assets/image-20240707144509431.png)
...
![image-20240708142344365](./assets/image-20240708142344365.png)
...
![image-20240708153205734](./assets/image-20240708153205734.png)
...
![image-20240708162426917](./assets/image-20240708162426917.png)

![image-20240708163426406](./assets/image-20240708163426406.png)

 ![image-20240708163526410](./assets/image-20240708163526410.png)
...
- Dropout：Dropout 可以减少过拟合，在前向传播时，部分有概率设置为 0，降低连接数量
  ...
  ![image-20240709142824096](./assets/image-20240709142824096.png)
...
![image-20240709161746603](./assets/image-20240709161746603.png)
...
![image-20240709170855124](./assets/image-20240709170855124.png)
...
- Container
  ...
  ![image-20240710141949725](./assets/image-20240710141949725.png)

- parameters 返回 net 的所有参数

  ![image-20240710142300668](./assets/image-20240710142300668.png)

- modules

  可以查看 net 下包含自己的所有 module，孩子 module

  ![image-20240710142636431](./assets/image-20240710142636431.png)

  ![image-20240710142653405](./assets/image-20240710142653405.png)
...
- save and load
  ...
  ![image-20240710142913658](./assets/image-20240710142913658.png)

- train / test

  完成所有 module train 状态 test 状态的切换

  ![image-20240710143222976](./assets/image-20240710143222976.png)

- implement own layer

  自己实现 tensor 的打平类

  ![image-20240710143521116](./assets/image-20240710143521116.png)

- own linear layer

  自定义 linear 类

  ![image-20240710143819537](./assets/image-20240710143819537.png)
