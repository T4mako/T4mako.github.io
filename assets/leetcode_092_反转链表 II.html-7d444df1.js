import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as e,c as p,e as o,b as n,d as l,f as c}from"./app-8bd73247.js";const i={},u=n("h1",{id:"_92-反转链表-ii",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_92-反转链表-ii","aria-hidden":"true"},"#"),l(" 92. 反转链表 II")],-1),r=c(`<p>解法：<br> 使用四个指针代表 start，end 和要改变方向的结点，最后再拼接起来</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Solution</span> <span class="token punctuation">{</span>
