import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o as t,c as p,e as o,b as n,d as c,f as l}from"./app-d04d8ffa.js";const i={},u=n("h1",{id:"_019-删除链表的倒数第-n-个结点",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_019-删除链表的倒数第-n-个结点","aria-hidden":"true"},"#"),c(" 019_删除链表的倒数第 N 个结点")],-1),r=l(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Solution</span> <span class="token punctuation">{</span>
